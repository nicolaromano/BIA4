...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.7\textwidth}
            \begin{itemize}[<+->]
                \item \textit{Weeks 1-4} - Basic operations on images, filters and features.
                \item \textit{Weeks 5-6} - More complex operations (e.g. feature extraction, tracking, segmentation, \dots).
                \item \textit{Weeks 8-12} - Traditional and modern (deep learning) machine learning methods for image analysis
                \item \textit{Week 13} - Discussion on recent topics in image analysis
            \end{itemize}
        \end{column}
        \begin{column}{0.3\textwidth}
            \begin{figure}
    ...
    Please note that \textbf{you will need Python knowledge} to pass this course.

    \pause

    I will also post \textbf{quizzes} on Learn after each lecture, to reinforce your understanding and \textbf{extra reading material} that will be useful to expand your image analysis knowledge.
\end{frame}
...
\begin{frame}
    ...
    I added you to a \textbf{Slack} group. Please join and introduce yourself, if you have not already!
