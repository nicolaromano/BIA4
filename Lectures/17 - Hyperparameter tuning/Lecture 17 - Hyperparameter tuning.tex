...
\begin{frame}
    ...
    \only<1>{
        \begin{codebox}
            \texttt{import tensorflow.keras as keras\\
                ...
                $~~~~$n\_units = hp.Int('units', min\_value=10, max\_value=100, step\_size=10)\\
                $~~~~$model.add(keras.layers.Conv2D(n\_units, (3, 3), activation='relu', $~~~~~~~~$input\_shape=(256, 256, 1)))\\
                $~~~~$\dots\\
                $~~~~$return model
            }
        \end{codebox}
